...
authorizations = {"basicAuth": {"type": "http", "scheme": "basic"}}

api = Namespace("user", description="Handles login", authorizations=authorizations)
...
class LoginResource(Resource):
    def post(self):
        return token_auth.generate(request.json["email"], request.json["password"])
